...
const translations = {
    en: {
        ...
        'team.alina_name': 'Alina',
        'team.alina_role': 'Administrator',
        'team.alina_exp': '2+ years',
        'team.alina_desc': 'Scheduling photo sessions and client coordination.',
        'team.alina_description': '<p>Alina is our dedicated administrator who ensures everything runs smoothly behind the scenes. With her excellent organizational skills and friendly approach, she handles client inquiries, schedules photo and video sessions, and coordinates our creative team.</p><p>Her attention to detail and proactive communication style make sure every client feels valued and informed — from the moment of booking to receiving your finished photos and videos.</p>',
        'team.oksana_name': 'Oksana',
        'team.oksana_role': 'Administrator',
        'team.oksana_exp': '1 year',
        'team.oksana_desc': 'Client support and administrative coordination.',
        'team.oksana_description': '<p>Oksana is our administrator dedicated to providing excellent client support and seamless administrative coordination. With her friendly and professional approach, she handles client communications, assists with booking inquiries, and ensures that every interaction is smooth and efficient.</p><p>Her commitment to customer satisfaction and attention to detail help maintain the high standards of service that Memori is known for. Oksana works closely with our team to coordinate schedules and ensure that all administrative processes run smoothly, making sure clients receive timely responses and clear information about our services.</p>',
    ...
    cs: {
        ...
        'team.alina_name': 'Alina',
        'team.alina_role': 'Administrátor',
        'team.alina_exp': '2+ roky',
        'team.alina_desc': 'Plánování focení a koordinace s klienty.',
        'team.alina_description': '<p>Alina je naše oddaná administrátorka, která zajišťuje hladký chod všeho v zákulisí. S vynikajícími organizačními schopnostmi a přátelským přístupem vyřizuje dotazy klientů, plánuje foto a video sezení a koordinuje náš kreativní tým.</p><p>Její pozornost k detailům a proaktivní komunikační styl zajišťují, že se každý klient cítí ceněný a informovaný — od okamžiku rezervace až po obdržení hotových fotografií a videí.</p>',
        'team.oksana_name': 'Oksana',
        'team.oksana_role': 'Administrátor',
        'team.oksana_exp': '1 rok',
        'team.oksana_desc': 'Podpora klientů a administrativní koordinace.',
        'team.oksana_description': '<p>Oksana je naše administrátorka věnovaná poskytování vynikající podpory klientům a bezproblémové administrativní koordinaci. S přátelským a profesionálním přístupem řeší komunikaci s klienty, pomáhá s dotazy na rezervace a zajišťuje, aby každá interakce byla plynulá a efektivní.</p><p>Její závazek k spokojenosti zákazníků a pozornost k detailům pomáhají udržovat vysoké standardy služeb, pro které je Memori známé. Oksana úzce spolupracuje s naším týmem na koordinaci rozvrhů a zajištění, aby všechny administrativní procesy probíhaly hladce, a klienti dostávali včasné odpovědi a jasné informace o našich službách.</p>',
    ...
    uk: {
        ...
        'team.alina_name': 'Аліна',
        'team.alina_role': 'Адміністратор',
        'team.alina_exp': '2+ роки',
        'team.alina_desc': 'Планування фотосесій та координація з клієнтами.',
        'team.alina_description': '<p>Аліна — наш відданий адміністратор, яка забезпечує безперебійну роботу за лаштунками. З чудовими організаційними навичками та дружелюбним підходом вона обробляє запити клієнтів, планує фото- та відеозйомки і координує нашу креативну команду.</p><p>Її увага до деталей та проактивний стиль комунікації гарантують, що кожен клієнт почувається цінним та поінформованим — від моменту бронювання до отримання готових фотографій та відео.</p>',
        'team.oksana_name': 'Оксана',
        'team.oksana_role': 'Адміністратор',
        'team.oksana_exp': '1 рік',
        'team.oksana_desc': 'Підтримка клієнтів та адміністративна координація.',
        'team.oksana_description': '<p>Оксана — наш адміністратор, яка присвячена наданню відмінної підтримки клієнтам та бездоганній адміністративній координації. З дружелюбним та професійним підходом вона обробляє комунікацію з клієнтами, допомагає з запитами щодо бронювання та забезпечує, щоб кожна взаємодія була плавною та ефективною.</p><p>Її зобов\'язання перед задоволенням клієнтів та увага до деталей допомагають підтримувати високі стандарти обслуговування, за які відоме Memori. Оксана тісно співпрацює з нашою командою для координації розкладів та забезпечення того, щоб усі адміністративні процеси проходили бездоганно, гарантуючи клієнтам своєчасні відповіді та чітку інформацію про наші послуги.</p>',
